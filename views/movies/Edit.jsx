            ...
            <DefaultLayout>
                <form action= {`/movies/${movie._id}?_method=PUT`} method="POST">
                    <fieldset>
                        ...
                        <label>
                            GENRE:<input type="text" name="genre" placeholder="Enter genre name" value={movie.genre} />
                        </label>
                        <label>
                        ...
                        <label>
                            CAST (Please separate cast members with commas):<input type="text" name="cast" value={movie.cast.join(",")} />
                        </label>
                        {
                            movie.watchAgain ?
